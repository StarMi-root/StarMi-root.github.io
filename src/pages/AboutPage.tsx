...
const TIMELINE = [
  {
    year: "2016",
    title: "荷叶创刊",
    desc: "暴雨后的清晨，4 只蛙在一片巴掌大的荷叶上印出第一份报纸，发行 37 份，头条是《雨停了，虫子多了》。",
  },
  {
    year: "2018",
    title: "发行破十万",
    desc: "「蚊虫涨价风波」系列报道引发全塘关注，发行量首次突破十万份，邮递队伍扩编至三十只。",
  },
  {
    year: "2021",
    title: "蝌蚪通讯社成立",
    desc: "自建塘间通讯网络，实现三百米内新闻十分钟直达，「呱速」一词被写入塘语词典。",
  },
  {
    year: "2024",
    title: "全媒体矩阵",
    desc: "上线视频新闻与水声广播，首次实现「看得见的蛙鸣」。同年编辑部完成第三次搬迁，搬进恒温睡莲大厦。",
  },
  {
    year: "2026",
    title: "新官网上线",
    ...
    <div className="page-in max-w-7xl mx-auto px-4 sm:px-6 pt-10 sm:pt-14 pb-6">
      ...
      <section className="grid lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-7">
          ...
          <p className="fade-up mt-6 max-w-xl text-[15px] leading-relaxed text-mist/65" style={{ animationDelay: "420ms" }}>
            蛙蛙新闻网创立于 2016 年，社址位于青蛙塘中央睡莲大厦三层。作为塘域最具影响力的两栖类媒体，
          ...
          <p className="fade-up mt-4 max-w-xl text-[15px] leading-relaxed text-mist/65" style={{ animationDelay: "520ms" }}>
            十年间，我们的记者去过最深的塘底、最高的芦苇梢，也被暴雨冲走过两次——报纸从未停刊。
          </p>
      ...
      <section className="mt-16 sm:mt-24">
        <Reveal className="mb-10">
          ...
          <h2 className="font-display text-3xl sm:text-4xl text-mist mt-2">十年编年史</h2>
        </Reveal>
          ...
          {TIMELINE.map((t, i) => (
            <Reveal key={t.year} delay={i * 80} className="relative">
              ...
              <div className="flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-6">
                <span className="font-display text-3xl sm:text-4xl text-gold shrink-0 w-24">{t.year}</span>
